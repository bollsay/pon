...
// ! multyLang
	...
	let arrLang = {
		'ru': {
			...
			'qs-5' : 'Отправить',
			// maps
			'm-0' : 'ОБЩЕСТВЕННОЕ ОБЪЕДИНЕНИЕ «КАЗАХСТАНСКИЙ ОТРАСЛЕВОЙ ПРОФЕССИОНАЛЬНЫЙ СОЮЗ РАБОТНИКОВ ОБРАЗОВАНИЯ И НАУКИ»',
			'm-1' : 'Наш адрес:',
			'm-1-0' : 'Казахстан, Нур-Султан (Астана), проспект Абая, 38',
			'm-2' : 'Наш E-mail адрес:',
			'm-2-0' : 'E-mail: proin.kz@mail.ru',
			'm-3' : 'Наш сайт:',
			'm-3-0' : 'www.edu-tradeunion.kz',
			'm-4' : 'Как нас найти',
		},
		'kz': {
			// Index.html
			...
			'qs-5' : 'Хат жіберу',
			// maps
			'm-0' : '«БІЛІМ ЖӘНЕ ҒЫЛЫМ ҚЫЗМЕТКЕРЛЕРІНІҢ ҚАЗАҚСТАНДЫК ӨНДІРІСТІК КӘСІБИ ОДАҒЫ» ҚОҒАМДЫҚ ҚАУЫМДАСТЫҒЫ',
			'm-1' : 'Біздің мекен-жайымыз:',
			'm-1-0' : 'Қазақстан, Нұр-Сұлтан (Астана), Абай даңғылы, 38',
			'm-2' : 'Электрондық пошта мекен-жайымыз:',
			'm-2-0' : 'proin.kz@mail.ru',
			'm-3' : 'Біздің веб-сайт:',
			'm-3-0' : 'www.edu-tradeunion.kz',
			'm-4' : 'Бізді қалай табуға болады',
		}
	}
